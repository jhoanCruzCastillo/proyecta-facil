  ...
  <div class="p-8">
    <div class="bg-surface-card rounded-xl shadow-card p-6 mb-6 flex items-center justify-between">
      <div class="flex items-center gap-4">
        <div class="w-14 h-14 rounded-xl bg-sidebar flex items-center justify-center text-white">
          <FontAwesomeIcon :icon="faUserGear" class="w-6 h-6" />
        </div>
        <div>
          <h1 class="text-2xl font-bold text-heading leading-tight">Usuarios y permisos</h1>
          <p class="text-sm text-muted">
            {{ actorRol === 'superusuario' ? 'Gestiona superusuarios, administradores, clientes y sus permisos' : 'Gestiona los clientes del sistema y sus permisos' }}
          </p>
        </div>
      </div>
